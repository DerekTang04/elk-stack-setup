...
curl --netrc-file ./.netrc -s -H 'Content-Type: application/json' -XGET http://localhost:9200/reactome-main*/_search/ -d "$QUERY" | jq -r "$JQ_FILTER" >> "$SCRIPT_DIR"/reports/"$FILE_NAME"
